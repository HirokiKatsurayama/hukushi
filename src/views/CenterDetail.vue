        ...
        <div class="lg:col-span-1 space-y-6">
          ...
          <div class="bg-gradient-to-br from-primary-500 to-primary-600 rounded-xl shadow-2xl sticky top-20 p-1">
            <div class="bg-white rounded-lg p-6">
              ...
              <button @click="$router.push('/document-request')" class="btn btn-secondary btn-lg w-full py-3 text-base font-bold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
